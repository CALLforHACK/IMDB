...
function create_and_append(category, title, id, date, path) {
    ...
    <button class="btn_1" data-id="${id}"><i class="bi bi-plus-square" style="color: aqua;"></i>Watch later</button>
    <button class="btn_2" data-id="${id}"><i class="bi bi-heart" style="color: red;"></i>Love</button>
         `;
